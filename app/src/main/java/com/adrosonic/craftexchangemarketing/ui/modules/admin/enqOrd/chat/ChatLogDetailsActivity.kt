...
//import com.adrosonic.craftexchangemarketing.LocalizationManager.LocaleBaseActivity
...
import com.adrosonic.craftexchangemarketing.databinding.ActivityChatLogBinding
import com.adrosonic.craftexchangemarketing.repository.data.request.chat.SendChatRequest
import com.adrosonic.craftexchangemarketing.ui.modules.admin.enqOrd.escalations.chatEscalationIntent
//import com.adrosonic.craftexchangemarketing.ui.modules.artisan.deliveryReceipt.UploadDeliveryReceiptActivity
...
//        mBinding?.chatView?.setLeftMessageTextColor(ContextCompat.getColor( this,  R.color.black_text))
    ...
    private fun loadMessages() {
        ...
        var mMessageList = GetMessageList.getMessageList(this,enquiryId?:0,"buyer")
        if (mMessageList == null) {
            mMessageList = ArrayList()
            mBinding?.noChat?.visibility = View.VISIBLE
            ...
            if(mMessageList.size == 0)
            {
                ...
                mBinding?.noChat?.visibility = View.GONE
