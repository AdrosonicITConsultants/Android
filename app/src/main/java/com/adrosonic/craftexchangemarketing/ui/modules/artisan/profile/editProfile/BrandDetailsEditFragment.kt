...
import com.adrosonic.craftexchangemarketing.databinding.FragmentBrandDetailsEditBinding
import com.adrosonic.craftexchangemarketing.repository.craftexchangemarketingRepository
import com.adrosonic.craftexchangemarketing.repository.data.request.editProfileModel.CompanyDetails
import com.adrosonic.craftexchangemarketing.repository.data.request.editProfileModel.EditArtisanBrand
import com.adrosonic.craftexchangemarketing.repository.data.response.artisan.editProfile.EditDetailsResponse
import com.adrosonic.craftexchangemarketing.ui.modules.artisan.profile.ArtisanProfileActivity.Companion.craftUser
...
//            Toast.makeText(requireContext(),"Save Brand Details Feature to be implemented", Toast.LENGTH_LONG).show()
            ...
            if(filePath != "" ){
                ...
                editBrandCall = craftexchangemarketingRepository.getUserService().editArtisanBrandDetailsPhoto(headerBoundary!!,token,editBrandDetails,brandLogoBody!!)
            }else{
...
//                headerBoundary="multipart/form-data;boundary="+ brandLogoBody?.boundary
                ...
                editBrandCall = craftexchangemarketingRepository
                    .getUserService()
