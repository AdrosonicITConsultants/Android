...
class FaultyRecyclerAdapter(var context: Context?, var escalationList: ArrayList<EscalationData> , val listener :(EscalationData ) -> Unit ) : RecyclerView.Adapter<FaultyRecyclerAdapter.MyViewHolder>(){


    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        var enquiryCode : TextView = view.findViewById(R.id.enquiryId)
        var escalationConcern: TextView = view.findViewById(R.id.escalationCategory)
        var date: TextView = view.findViewById(R.id.EscalationDate)
        var img : ImageView = view.findViewById(R.id.raisedby)
        var layout : ConstraintLayout = view.findViewById(R.id.FaultyLayout)
...
//        var daysago: TextView = view.findViewById(R.id.DaysAgo)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.escalation_faulty_row, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder?.escalationConcern?.text = escalation?.category
