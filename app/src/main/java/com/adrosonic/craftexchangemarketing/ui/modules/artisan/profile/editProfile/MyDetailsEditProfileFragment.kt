...
import com.adrosonic.craftexchangemarketing.databinding.FragmentMyDetailsEditProfileBinding
...
import com.adrosonic.craftexchangemarketing.repository.data.request.editProfileModel.Country
...
//            if(filePath.isNotEmpty()){
            ...
            if(filePath != "" ){
                ...
                editDetailsCall = craftexchangemarketingRepository
                    .getUserService()
...
//                headerBoundary="multipart/form-data;boundary="+ profilePicBody?.boundary
                ...
                editDetailsCall = craftexchangemarketingRepository.getUserService().editArtisanProfileDetails(token,address)
