package com.adrosonic.craftexchangemarketing.ui.modules.admin.enqOrd.escalations.adapter
...
import com.adrosonic.craftexchangemarketing.ui.modules.buyer.wishList.WishlistAdapter
...
class EscalationRecyclerAdapter(var context: Context?, private var escalation:List<EscSumData>) : RecyclerView.Adapter<EscalationRecyclerAdapter.MyViewHolder>() {
