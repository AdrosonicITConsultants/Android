...
public class ColumnHeaderViewHolder extends AbstractSorterViewHolder {
    ...
    public void setSelected(SelectionState p_nSelectionState) {
        ...
        nBackgroundColorId = R.color.table_column_head_bg_color;//R.color.shadow_background_color;
        nForegroundColorId = R.color.table_corner_text_color;//R.color.unselected_text_color;
...
//        }
    ...
    private void controlSortState(SortState pSortState) {
        if (pSortState == SortState.ASCENDING) {
            ...
            column_header_sort_button.setImageResource(R.drawable.ic_arrow_down);

        } else if (pSortState == SortState.DESCENDING) {
            column_header_sort_button.setVisibility(View.VISIBLE);
            column_header_sort_button.setImageResource(R.drawable.ic_arrow_upward_20);
        } else {
