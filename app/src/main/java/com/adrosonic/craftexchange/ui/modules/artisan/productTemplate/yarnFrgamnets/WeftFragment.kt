...
class WeftFragment : Fragment() {
    interface WeftFragmentListner {
        fun sendWeftData(yarnType: Long, yarnCount: String, dye: Long)
    }
    private var productId: Long? = 0
    private var isTemplate: Boolean? = true

    var listener: WeftFragmentListner? = null
    ...
    fun callListener() {
        ...
        UserConfig.shared.weftYarnId=yarnTypeId
        UserConfig.shared.weftYarnCount=yarnCnt
        UserConfig.shared.weftDyeId=dyeId
    }
    companion object {
        @JvmStatic
