...
class BuyerOnGoTransacFragment : Fragment(),
TransactionViewModel.TransactionInterface{
    ...
    var mTranListAdapter : BuyerOnGoTranRecyclerAdapter?= null
    ...
    private fun setRecyclerList(){
        ...
        mTranListAdapter = BuyerOnGoTranRecyclerAdapter(
            requireContext(),
...
//        mEnqListAdapter?.enqListener = this  //important to set adapter first and then call listener
    ...
    companion object {
        fun newInstance() = BuyerOnGoTransacFragment()
    }
}