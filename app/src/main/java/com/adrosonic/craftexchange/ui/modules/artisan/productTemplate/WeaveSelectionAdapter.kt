...
class WeaveSelectionAdapter(
    private val context: Context,
    private val pairList: ArrayList<Triple<String, Boolean, Long>>//dscrp, selcted-unselected,id
) : RecyclerView.Adapter<WeaveSelectionAdapter.MyViewHolder>() {

    interface selectionListener {
        fun onWeaveItemSelected(pairList: ArrayList<Triple<String, Boolean, Long>>)
    }
    var listener: WeaveSelectionAdapter.selectionListener? = null
...
//        notifyItemRemoved(position)
        ...
        listener?.onWeaveItemSelected(pairList)
    }
