                    ...
                    if (iterator != null) {
                        while (iterator.hasNext()) {
                            ...
                            if (orderObj == null) {
                                ...
                                exEnq?.productCategoryId =
                                    order?.openEnquiriesResponse?.productCategoryId
                                ...
                                exEnq?.alternateMobile =
                                    order?.openEnquiriesResponse?.alternateMobile
                                ...
                                exEnq?.extraWeftYarnId =
                                    order?.openEnquiriesResponse?.extraWeftYarnId
                                ...
                                exEnq?.productStatusId =
                                    order?.openEnquiriesResponse?.productStatusId ?: 0
                                ...
                                exEnq?.orderReceiveDate =
                                    order?.openEnquiriesResponse?.orderReceiveDate
                                exEnq?.excpectedDate = order?.openEnquiriesResponse?.excpectedDate
                                exEnq?.changeRequestModifiedOn =
                                    order?.openEnquiriesResponse?.changeRequestModifiedOn
                                exEnq?.innerEnquiryStageId =
                                    order?.openEnquiriesResponse?.innerEnquiryStageId
                                exEnq?.enquiryStageId = order?.openEnquiriesResponse?.enquiryStageId
                                exEnq?.startedOn = order?.openEnquiriesResponse?.startedOn
                                exEnq?.changeRequestStatus =
                                    order?.openEnquiriesResponse?.changeRequestStatus ?: 0L
                                exEnq?.pocFirstName = order?.openEnquiriesResponse?.pocFirstName
                                exEnq?.productCategoryHistoryId =
                                    order?.openEnquiriesResponse?.productCategoryHistoryId
                                exEnq?.warpYarnHistoryId =
                                    order?.openEnquiriesResponse?.warpYarnHistoryId
                                exEnq?.weftYarnHistoryId =
                                    order?.openEnquiriesResponse?.weftYarnHistoryId
                                exEnq?.extraWeftYarnHistoryId =
                                    order?.openEnquiriesResponse?.extraWeftYarnHistoryId
                                exEnq?.productStatusHistoryId =
                                    order?.openEnquiriesResponse?.productStatusHistoryId
                                exEnq?.madeWittAnthranHistory =
                                    order?.openEnquiriesResponse?.madeWittAnthranHistory
                                exEnq?.buyerRatingDone =
                                    order?.openEnquiriesResponse?.buyerRatingDone
                                exEnq?.deliveryChallanUploaded =
                                    order?.openEnquiriesResponse?.deliveryChallanUploaded
                                exEnq?.deliveryChallanLabel =
                                    order?.openEnquiriesResponse?.deliveryChallanLabel
                                exEnq?.historyProductId =
                                    order?.openEnquiriesResponse?.historyProductId
                                exEnq?.madeWittAnthran =
                                    order?.openEnquiriesResponse?.madeWittAnthran
                                exEnq?.productHistoryImages =
                                    order?.openEnquiriesResponse?.productHistoryImages
                                exEnq?.enquiryStatusId =
                                    order?.openEnquiriesResponse?.enquiryStatusId
                                ...
                                exEnq?.productHistoryCode =
                                    order?.openEnquiriesResponse?.productHistoryCode
                                exEnq?.productHistoryName =
                                    order?.openEnquiriesResponse?.productHistoryName
                                ...
                                orderObj?.description =
                                    order?.openEnquiriesResponse?.description//todo
                                ...
                                orderObj?.extraWeftYarnId =
                                    order?.openEnquiriesResponse?.extraWeftYarnId
                                orderObj?.email = order?.openEnquiriesResponse?.email
                                Log.e(
                                    "OrderDetails",
                                    "enquiryId " + order?.openEnquiriesResponse?.enquiryId
                                )
//                                orderObj?.enquiryId = order?.openEnquiriesResponse?.enquiryId
                                ...
                                orderObj?.productStatusId =
                                    order?.openEnquiriesResponse?.productStatusId ?: 0
                                orderObj?.productType =
                                    order?.openEnquiriesResponse?.productType ?: ""
                                orderObj?.district = order?.openEnquiriesResponse?.district
                                orderObj?.productName =
                                    order?.openEnquiriesResponse?.productName ?: ""
                                Log.e("OrderDetails", "33333333333333333")
                                orderObj?.productCode = order?.openEnquiriesResponse?.productCode
                                orderObj?.productImages =
                                    order?.openEnquiriesResponse?.productImages
                                orderObj?.orderReceiveDate =
                                    order?.openEnquiriesResponse?.orderReceiveDate
                                orderObj?.excpectedDate =
                                    order?.openEnquiriesResponse?.excpectedDate
                                orderObj?.changeRequestModifiedOn =
                                    order?.openEnquiriesResponse?.changeRequestModifiedOn
                                orderObj?.innerEnquiryStageId =
                                    order?.openEnquiriesResponse?.innerEnquiryStageId
                                orderObj?.enquiryStageId =
                                    order?.openEnquiriesResponse?.enquiryStageId
                                orderObj?.startedOn = order?.openEnquiriesResponse?.startedOn
                                orderObj?.changeRequestStatus =
                                    order?.openEnquiriesResponse?.changeRequestStatus
                                orderObj?.pocFirstName = order?.openEnquiriesResponse?.pocFirstName
                                orderObj?.productCategoryHistoryId =
                                    order?.openEnquiriesResponse?.productCategoryHistoryId
                                orderObj?.warpYarnHistoryId =
                                    order?.openEnquiriesResponse?.warpYarnHistoryId
                                orderObj?.weftYarnHistoryId =
                                    order?.openEnquiriesResponse?.weftYarnHistoryId
                                Log.e("OrderDetails", "444444444444444444")
                                orderObj?.extraWeftYarnHistoryId =
                                    order?.openEnquiriesResponse?.extraWeftYarnHistoryId
                                orderObj?.productStatusHistoryId =
                                    order?.openEnquiriesResponse?.productStatusHistoryId
                                orderObj?.madeWittAnthranHistory =
                                    order?.openEnquiriesResponse?.madeWittAnthranHistory
                                orderObj?.buyerRatingDone =
                                    order?.openEnquiriesResponse?.buyerRatingDone
                                orderObj?.deliveryChallanUploaded =
                                    order?.openEnquiriesResponse?.deliveryChallanUploaded
                                orderObj?.deliveryChallanLabel =
                                    order?.openEnquiriesResponse?.deliveryChallanLabel
                                orderObj?.historyProductId =
                                    order?.openEnquiriesResponse?.historyProductId
                                orderObj?.madeWittAnthran =
                                    order?.openEnquiriesResponse?.madeWittAnthran
                                orderObj?.productHistoryImages =
                                    order?.openEnquiriesResponse?.productHistoryImages
                                orderObj?.enquiryStatusId =
                                    order?.openEnquiriesResponse?.enquiryStatusId
                                ...
                                orderObj?.productHistoryCode =
                                    order?.openEnquiriesResponse?.productHistoryCode
                                orderObj?.productHistoryName =
                                    order?.openEnquiriesResponse?.productHistoryName
